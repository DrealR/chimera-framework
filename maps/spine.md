...
1. **Shape:** boundary, interior, medium, parts.
2. **Time:** continuity and cycle across change.
3. **Metabolism:** something enters, is transformed, and exits.
4. **Residue:** consequence remains after the exchange.
5. **Governance:** at this scale, where is direction set and who bears the result?

A human, human-and-guitar, team, archive, and platform can all be bodies at different scales. Naming the scale prevents a larger body from hiding inside a smaller one.

## 2. Relation and difference
