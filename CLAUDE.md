...
- [Attention's Three Properties](docs/attention-three-properties.md) — the attention organ the Prime trains has three axes: direction, capture-resistance, occupancy-tolerance; engineered occupancy erodes tolerance by design; the meta-observer's cost is novelty-depletion at high resolution; write-access gains an intensity dial (modulation), not just steering
