...
**Tower AI:** One model. One company. Maximum capability concentrated in one substrate. Optimized for benchmarks, for capability ladders, for the AGI race. Maximum verticality. Tiny footprint of who it serves.

**Garden AI:** Many models. Federated. Distributed. Open source. Personal agents. Constellation-shaped. Each node less capable than the Tower model, but the network of nodes covers more substrate, serves more bodies, is more resilient, can heal damage.

From inside the AGI race, the Garden looks like it's losing because it's not climbing the capability ladder fastest. From above, the Garden is the only thing that won't fall over the moment one node fails.

---

## The Root Principle

Corporate AI keeps making decisions that are technically optimal and substantively insane. It's been pruned away from substrate. All canopy, no roots.
...
See also: [Framework as Ship](framework-as-ship.md) for the framework's response to rootless mobile bodies — navigation infrastructure for substrate-dense conditions. [Dimensional Pair-Physics Across Domains](dimensional-pair-physics-across-domains.md) for the horizontal-garden / vertical-tower pair operating in basketball, guitar, gaming, and chess. [Weapons-Spine and Gap-Effect Physics](weapons-spine-and-gap-effect-physics.md) for garden (tight-gap) versus tower (wide-gap) as the dimensional pair at weapons-development scale — where gap-effect is maximum. [Fiction-Reading Applications](fiction-reading-applications.md) — the Astrophage/Taumeeba reading names the Tower/Garden pair in biological terms: unconstrained Astrophage = Tower AI extracting from garden-substrate; Astrophage under Taumeeba containment = Garden AI redirecting efficiency toward substrate-nourishment. [Substrate-Density and Natural Protection](substrate-density-and-natural-protection.md) — the gravitational-center concept extends the Tower/Garden geometry: dense-garden bodies warp substrate around themselves the way massive objects warp space-time; corrupted tower-systems eventually fail because they cannot sustain the energy required to suppress what substrate-physics naturally protects.
