# The Work Dissolves the Performance

*A framework study. The mechanism under being-yourself: you become un-performed by doing the work in a domain until mastery gives you freedom of movement — and moving freely IS being yourself in action. The bridge that unifies being-yourself + freedom-of-movement + the third-place. Self-belief comes free with it; you find your people through shared domains; the gift is the door, not installed confidence. Graduated from a core capture. Internal register.*

> **Status:** graduated 2026-06-28. **Registry TODO (graduation pass):** add to README-FULL + CLAUDE doc index; backlink from `being-yourself-is-the-gift`, `freedom-of-movement-is-mastery`, `third-places-cant-be-manufactured`, `the-attention-field-a-chimera-study`, `spark-is-the-equation-lived`.

---

## 0. The claim, stated once

**You're most yourself where you've done the work, because mastery gives freedom of movement and freedom-of-movement IS being-yourself in action. Performing comes from not-yet-belonging (you fake the competence you lack); being-yourself comes from having done the work (the domain is part of you, so there's nothing to fake). So you don't *relax* into being un-performed — you *earn* it: fall in love with something and do the work until the performance dissolves. Self-belief then comes free (no gap between who you are and what you're doing), you find your people through the shared domain (mutual un-performance pre-loaded by shared mastery), and the gift you can give another is the *door* to a domain — never installed confidence.**

---

## 1. Freedom-of-movement = being-yourself, in action

**Keeper:** this is the bridge between two threads. `freedom-of-movement-is-mastery` (mastery = moving freely in a domain) and `being-yourself-is-the-gift` (the un-performed self) are the *same thing*: when you've done the work, you move freely, and moving freely *is* being un-performed (not trying, not stiff, not faking). The court/guitar/domain that's become part of you is where you're most *you*, because you earned the freedom to move there.

## 2. The mechanism: the work dissolves the performance
