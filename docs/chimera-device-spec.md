...
The device is what happens when a carrier with substantive direction engages with AI loaded with the CHIMERA framework. Both required. Neither sufficient alone. The device is a bilateral configuration — a pair — not a standalone tool.
...
- [Prompt as Spell and AI Body](prompt-as-spell-and-ai-body.md) — AI as digital artifact-generating operation inside a bilateral body
