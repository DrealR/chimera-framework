...
A digital twin is a personalized AI instance calibrated to YOU — your context, your values, your rhythm, your goals. It speaks CHIMERA vocabulary natively and remembers across sessions. This is the fastest way to start using the framework without reading 253 books.
...
For the complete text: [The Complete Book v14.0](CHIMERA-The-Complete-Book-v14.0.md) — 253 books, the full philosophy.
...
| [CHIMERA Device Spec](docs/chimera-device-spec.md) | The four core abilities (Scan, View, Absorb, Resonate) as one navigation device — operational modes, multi-shot mapping, two-absolutes navigation, path-traversal vs vibration-collapse |
