...
| [Scenes and the Witness](docs/scenes-and-the-witness.md) | The social half of the write surface — witnessed writes are deeper; the shared referee (physical co-presence as perception's checksum); the actor/spectator asymmetry; the scene-entry test; witness architecture as a write-access decision |
