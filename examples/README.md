...
82 body scans across 9 domains + adversarial, produced using CHIMERA Body Scan Protocol v3.11/v3.12/v3.12.1. All standard scans have companion YAML data files for programmatic querying.
...
| [Social Systems](social-systems/) | 2 | Social structures, communication substrates, and economies |
| **[Multi-Body](multi-body/)** | **3** | **Relational scans — composites of existing bodies (Phase 4)** |

## How to Read a Scan

Every scan follows the same protocol:
1. **Identity** — what is this body?
2. **Nine Questions** — the foundational reading
3. **Bump Detection** — what's blocked?
4. **Skeleton** — one sentence of irreducible truth
5. **DNA Layer** — O>I / I>O / Mixed / Conditional reading
6. **Advanced Diagnostics** — five god powers, prime, federation/dominion, surfaces, attention
7. **Structural Weakness** — honest limitations and inversion conditions
8. **Cross-Domain Connections** — where this body's patterns appear elsewhere
9. **Fruit** — what new understanding emerged
10. **Powers Detected** — named capabilities
...
- [META-SCAN-SYNTHESIS v6](META-SCAN-SYNTHESIS-v6.md) — Sixth audit — v3.12.3 methodology review, structural debt diagnosis (current)
- [META-SCAN-SYNTHESIS v5](META-SCAN-SYNTHESIS-v5.md) — Fifth audit of the 82-scan corpus — Phase 5 launch
